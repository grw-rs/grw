...
<svg viewBox="0 0 420 130" style="max-width:420px;display:block;margin:1em auto" role="img" aria-label="Cycle: homo endpoints collapse onto one node, the mono path loops back">
  ...
  <circle cx="170" cy="82" r="17" fill="#f0a63f22"/><circle cx="170" cy="82" r="12" fill="#f0a63f"/>
  <text x="170" y="86" text-anchor="middle" font-family="monospace" font-size="11" font-weight="600" fill="#1a1205">0=1</text>
...
<svg viewBox="0 0 440 150" style="max-width:440px;display:block;margin:1em auto" role="img" aria-label="A free witness node collapsing onto the mono neighbor it duplicates">
  ...
  <circle cx="84" cy="70" r="16" fill="#f0a63f22"/><circle cx="84" cy="70" r="11" fill="#f0a63f"/>
  <text x="84" y="74" text-anchor="middle" font-family="monospace" font-size="12" font-weight="600" fill="#1a1205">0</text>
  <circle cx="246" cy="70" r="16" fill="#f0a63f22"/><circle cx="246" cy="70" r="11" fill="#f0a63f"/>
  <text x="246" y="74" text-anchor="middle" font-family="monospace" font-size="12" font-weight="600" fill="#1a1205">1</text>
  <line x1="110" y1="56" x2="300" y2="26" stroke="#46c6d6" stroke-width="2" stroke-dasharray="5 5"/>
  <circle cx="318" cy="24" r="12" fill="none" stroke="#f0a63f" stroke-width="2" stroke-dasharray="4 4"/>
  <text x="318" y="28" text-anchor="middle" font-family="monospace" font-size="12" font-weight="600" fill="#f0a63f">2</text>
...
<svg viewBox="0 0 460 120" style="max-width:460px;display:block;margin:1em auto" role="img" aria-label="Adjacent collapse requires a self-loop on the target">
  ...
  <circle cx="55" cy="60" r="11" fill="#f0a63f"/><text x="55" y="64" text-anchor="middle" font-family="monospace" font-size="11" font-weight="600" fill="#1a1205">0</text>
  <circle cx="175" cy="60" r="11" fill="#f0a63f"/><text x="175" y="64" text-anchor="middle" font-family="monospace" font-size="11" font-weight="600" fill="#1a1205">1</text>
  ...
  <circle cx="320" cy="60" r="11" fill="#f0a63f"/><text x="320" y="64" text-anchor="middle" font-family="monospace" font-size="10" font-weight="600" fill="#1a1205">0=1</text>
...
<svg viewBox="0 0 440 150" style="max-width:440px;display:block;margin:1em auto" role="img" aria-label="Two paths forced through one interior: rejected under Mono, accepted under Homo">
  <circle cx="60" cy="75" r="11" fill="#f0a63f"/><text x="60" y="79" text-anchor="middle" font-family="monospace" font-size="11" font-weight="600" fill="#1a1205">0</text>
  <circle cx="220" cy="40" r="9" fill="#46c6d6"/><text x="220" y="22" text-anchor="middle" font-family="monospace" font-size="11" fill="#8b95a9">x</text>
  <circle cx="380" cy="75" r="11" fill="#f0a63f"/><text x="380" y="79" text-anchor="middle" font-family="monospace" font-size="11" font-weight="600" fill="#1a1205">2</text>
  <circle cx="220" cy="110" r="11" fill="#f0a63f"/><text x="220" y="114" text-anchor="middle" font-family="monospace" font-size="11" font-weight="600" fill="#1a1205">1</text>
